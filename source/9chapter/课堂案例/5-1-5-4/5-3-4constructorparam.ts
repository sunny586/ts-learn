...
class TestClass {// 准备类
  constructor(public username: string, public classno: number, public address: string) {
  }
  eat() {
    console.log("姓名为: " + this.username + ", 班级：" + this.classno + ", 地址：" + this.address);
  }
}
...
createInstance<TestClass, typeof TestClass>(TestClass, "wangwu", 105, 'shenzhen').eat();
export { }
